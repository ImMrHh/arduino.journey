...
<div class="download-buttons">
  <a href="{{ '/robotics/code/scanner.ino' | relative_url }}" download class="download-btn">
    Download scanner.ino
  </a>
  <p>→ Scans the I2C bus to detect the LCD address.</p>

  <a href="{{ '/robotics/code/lcd-test.ino' | relative_url }}" download class="download-btn">
    Download lcd-test.ino
  </a>
  <p>→ Simple test to confirm LCD wiring and address.</p>

  <a href="{{ '/robotics/code/jumpman.ino' | relative_url }}" download class="download-btn">
    Download jumpman.ino
  </a>
